...
#define ADDRESS_HW_X10_100_PERCENT_OFFSET_0   9 + EEPROM_BASE_ADDRESS
#define ADDRESS_HW_X10_100_PERCENT_OFFSET_1   10 + EEPROM_BASE_ADDRESS
#define ADDRESS_HW_X10_100_PERCENT_OFFSET_2   11 + EEPROM_BASE_ADDRESS
#define ADDRESS_HW_X10_100_PERCENT_OFFSET_3   12 + EEPROM_BASE_ADDRESS
#define ADDRESS_SHOW_NUMERIC_BATTERY_SOC      13 + EEPROM_BASE_ADDRESS
#define ADDRESS_ODOMETER_FIELD_STATE          14 + EEPROM_BASE_ADDRESS
#define ADDRESS_TARGET_MAX_BATTERY_POWER      15 + EEPROM_BASE_ADDRESS
